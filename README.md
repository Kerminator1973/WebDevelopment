...
[Альтернативы JavaScript: WebAssembly, TypeScript](#alt_javascript)
[Основные проблемы web-приложений](#problems)
[Решение проблем при помощи фреймворков](#frameworks)
