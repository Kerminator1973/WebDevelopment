...
Считается, что WebPack является сложным в использовании инструментом, поскольку он появился одним из первых и он поддерживает большое количество _legacy_ технологий. В качестве альтернатив рассматриваются:
...
Вместе с тем, WebPack 5 может быть совсем другой историей: https://webpack.js.org/blog/2020-10-10-webpack-5-release/
