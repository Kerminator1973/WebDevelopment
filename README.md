...
Существует огромное количество облачных IDE. Для примера: [GitPod](https://www.gitpod.io/), [CodeAnywhere](https://codeanywhere.com/), [Github Codespaces](https://github.com/features/codespaces), [CodeSandBox](https://codesandbox.io/) и [StackBlitz](https://stackblitz.com/). Облачное средство прототипирования и экспериментирования - [CodePen](https://codepen.io/).
