...
> В приведённом выше примере можно увидеть, что в `#shadow-root` определено очень много span-ов и div-ов, а также огромное количество классов. Это означает, что кастомизация их визуального отображения будет очень сложной технической задачей.
