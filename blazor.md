...
- Вероятно, какие-то аппаратные платформы не совместимы с .NET. Допускаю, что могут быть проблемы на компьютерах с процессорными архитектурами Эльбрус (VLIW-архитектура), Loongson (на базе архитектуры MIPS)
