...
- в случае Blazor, JavaScript-разработчик для Front-а не нужен, остаётся потребность только в дизайнере и разработчике на C\#, котрый совмещает работу с Frontend и Backend
