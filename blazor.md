...
- при публикации приложения осуществляется трансляция IL-сборок в wasm. При этом [используется Node.js и JavaScript](./blazor_uses_nodejs.md), что очень сильно нагружает DevOps инфраструктуру
