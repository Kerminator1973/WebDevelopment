...
На практике, многие разработчики ПО не оплачивают доступ к LLM, используя бесплатные сервисы. Однако важно понимать коммерческие модели поставщиков услуг доступа к LLM. Для примера, компания Anthropic предоставляет доступ к моделям: Haiku, Sonet, Opus

- Haiku - быстрая и легковесная. К ней можно получить бесплатный доступ через агрегаторов
- Sonet - сбалансированная модель. Работает эффективно, существенно дешевле, чем Opus
...
Блок рассуждений (Claude Sonet 4.6 Thinking):
