...
Российский агент встраиваемый в VSCode - [KodaCode](https://kodacode.ru/). Работает с зарубежными LLM без прокси. Предлагает раздичные тарифные планы, включая бесплатный доступ. Требует авторизации на GitHub. Бесплатный тариф не предоставляет доступ к внешним LLM. Тариф Pro - 1590/месяц предоставляет возможность доступа китайским LLM (MiniMax M2.1, Qwen3, Kimi K2.5 Thinking, GLM 4.6). Можно докупить дополнительные пакеты - за 370 рублей можно купить 250 запросов ко внешним LLM. Есть поддержка IDE JetBrains. Разработчики - бывшие сотрудники СБЕРа, разрабатывавшие GigaCode. 
