...
>Яндекс запускает собственный ИИ для генерации кода [SourceCraft](https://sourcecraft.dev/), предоставляя plug-in Code Assistant для VSCode и IntelliJ IDEA. Тариф "Community" - бесплатный, тариф "Про" - 250 руб/месяц. Разница в хранилище данных (2 ГБ vs 10 ГБ) и количестве минут CI-процессов (800 vs 3000). Расширенные квоты для AI-помощника - 700 руб/месяц. Похоже на то, что SourceCraft больше похож на GitHub + Copilot, чем на Cloude Code, или KodaCode.
