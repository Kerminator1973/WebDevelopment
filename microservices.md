...
В выступлении "Микросервисы как худший архитектурный выбор для стартапа" Даниила Подольского на конференции "YADRO 2023" сделал несколько важных замечаний.

Микросервисы невозможны быть DevOps, автоматизации тестирования и развертывания.
...
Современные микросервис он уже совсем не микро - в сервисе есть СУБД, кэши (Redis), балансировщики, пара дополнительных микросервисов обеспечения, мониторинг, и т.д. Сейчас сложность одного микросервиса часто превышает сложность большой IT-системы десятилетней сложности.

Из-за высокой сложности интеграции сервисов друг с другом, добавлять принципиально новые features в систему становится очень дорого. В этом случае микросервисная архитектура перестаёт быть гибкой.

Современный проект - это несколько команд и избежать микросервисной архитектуры крайне затруднительно. В таким ситуациях микросервисная архитектура получается из организационной структуры.
