...
> При отладке кода столкнулся со странной ситуацией: точка останова не страбатывает в Visual Studio 2022, но сам код выполняется и можно увидеть вывод в консоль браузера, который осуществляется строкой: `Console.WriteLine($"Selected model: {model}");`
