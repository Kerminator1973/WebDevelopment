...
Допустим, мы выбрали две векторных иконки "pencil" и "user" на сайте [FontAwesome](https://fontawesome.com/icons?d=gallery) и решили поместить их в один SVG-файл (например, "devices.svg"). Выглядеть объединённый файл может так:
...
```html
<svg class="icon"><use xlink:href="/img/images.svg#user"></use></svg>
```
...
**Update 2026**: в современных браузерах можно использовать обычный `href`, а не `xlink:href=`:

```html
<svg class="table-icon"><use href="images/devices.svg#bcr"></use></svg>
```
