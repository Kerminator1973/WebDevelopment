...
![Профиль публикации VS20202](/images/launchProfilesVS2022.png)
...
После того, как компонент будет установлен, нужно будет включить "Провреку подлинности Windows" и отключить "Анонимную проверку подлинности".
