...
Затем компиляторы потребовал выполнить команду:
...
- компилирует Си-код, вероятно, связанный с wasm в объектные модули wasm (.0)
...
Таким образом, можно говорить о том, что оптимизация приложения по производительности, приводит к увеличению объёма приложения в два раза.
