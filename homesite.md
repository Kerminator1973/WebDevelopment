...
Для небольших локальных сетей можно применять протокол mDNS, который поддерживается даже некоторыми микроконтроллерами.
...
mDNS может работать в сочетании с обнаружением служб DNS (DNS-SD), сопутствующим сетевым методом с нулевой конфигурацией, указанным отдельно в IETF RFC 6763.
