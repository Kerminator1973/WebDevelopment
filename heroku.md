...
В разделе «Resource» в Heroku Dashboard следует добавить Add-on: **Heroku Postgres**. Бесплатный тарифный план называется "Hobby Dev - Free". Можно зайти в консоль Heroku и скопировать параметры доступа к базе данных из соответствующего раздела.
